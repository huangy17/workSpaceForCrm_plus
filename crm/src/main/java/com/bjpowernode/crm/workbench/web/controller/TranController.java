...
//        t.setExpectedDate(expectedDate);
    ...
    private ModelAndView detail(HttpServletRequest request, HttpServletResponse response,
        ...
        Map<String,String> pMap = (Map<String,String>) sc.getAttribute("pMap");
        String possibility = pMap.get(stage);
    ...
    private ModelAndView save(HttpServletRequest request, HttpServletResponse response,
                              Tran t, String customerName)throws ServletException, IOException {
